...
<img border="0" src="title_addband.jpg">
</td></tr>
<tr bgcolor="white"><td align="center">

<div id="contents">

    <form enctype="multipart/form-data" method="post" action="index.php?page=test_band.php">
    ...
    <input type="text" id="band_members" name="band_members" /><br />
